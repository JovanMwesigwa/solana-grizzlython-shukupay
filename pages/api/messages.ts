...
export function writeTokensOnSuccess(access_token: any, refresh_token: any, expires_at: any, merchant_id: any) {
    return (
    `
...
export function displayStateError() {
    return (
    ` 
      <link type="text/css" rel="stylesheet" href="style.css">
      <meta name="viewport" content="width=device-width">
...
export function displayError(error: any, error_description: any) {
  return (
  `
  <link type="text/css" rel="stylesheet" href="style.css">
  <meta name="viewport" content="width=device-width">
